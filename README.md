...
This repository contains the materials and instructions for the first laboratory session of the **SE 3006 Software Architectures** course, offered by the **Department of Software Engineering at Muğla Sıtkı Koçman University (MSKÜ)**. This lab is designed to introduce students to various software architecture styles.
